 ...
 */
public class Tier2ListViewAdapter extends ArrayAdapter<ListObject> {
    ArrayList<ListObject> items;
    Activity mContext;

    AssetManager assetManager;

    public Tier2ListViewAdapter(Activity context, ArrayList<ListObject> item) {
        super(context, R.layout.list_item_tier2, item);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.list_item_tier2, null, true);
